...
function Header() {
  ...
  return (
    <header className="main-header"> {/* Add a wrapper for header content */}
      <div className="college-name">
        <Link to="/">Vivekanand College</Link> {/* College Name/Logo for desktop & mobile */}
      </div>
      {/* Desktop Navigation */}
      <nav className="navbar desktop-nav">
        ...
        <Link to="/admissions" className="nav-item btn primary-btn">Apply Now!</Link> {/* Apply Now button */}
      </nav>
